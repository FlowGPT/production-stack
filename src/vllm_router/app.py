...
def initialize_all(app: FastAPI, args):
    ...
    initialize_routing_logic(
        ...
        p50_ttft_threshold=args.cache_aware_p50_ttft_threshold,
        p99_ttft_threshold=args.cache_aware_p99_ttft_threshold,
        p50_e2e_threshold=args.cache_aware_p50_e2e_threshold,
